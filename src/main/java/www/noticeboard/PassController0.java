...
@WebServlet("/WWW/01Login/www.noticeboard/pass.do")
public class PassController0 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/WWW/01Login/NoticePass.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		if (confirmed) {
			if (mode.equals("edit")) {
				...
				*/
				resp.sendRedirect("../www.noticeboard/edit.do?idx=" + idx);			
			}
				...
				//삭제가 완료되면 리스트로 이동한다.
				JSFunction.alertLocation(resp, "삭제되었습니다.", "../www.noticeboard/list.do");
			}	
		}
		else {
			//검증에 실패한 경우 뒤로 돌아간다.
