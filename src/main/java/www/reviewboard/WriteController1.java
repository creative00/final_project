 ...
 */
public class WriteController1 extends HttpServlet {
	
	//doGet은 글쓰기 페이지로 진입 시 요청을 처리. 단순한 포워드 기능만 있으면 됨
	
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.getRequestDispatcher("/WWW/051Reviewboard/ReviewWrite.jsp")
			.forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if ( result == 1) {
			...
			resp.sendRedirect("../www.reviewboard/list.do");
		}
		else {
			resp.sendRedirect("../www.reviewboard/write.do");
		}
	}
}
